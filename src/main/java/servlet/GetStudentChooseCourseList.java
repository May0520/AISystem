 ...
 */
@WebServlet(name = "GetStudentChooseCourseList")
public class GetStudentChooseCourseList extends HttpServlet {
    public JsonArray getCourseList(String student) {
        ...
        try {
            ...
            String sql = "select * from course_info where course_name not in (select distinct course_name from choose_course_info where student_name = ?)";
